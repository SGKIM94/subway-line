...
import static atdd.path.web.BaseURlGroup.FAVORITE_BASE_URL;

public class FavoriteAcceptanceTest extends atdd.path.AbstractAcceptanceTest {
    ...
    public void createFavoriteToStation(SoftAssertions softly) {
        ...
        EntityExchangeResult<Favorite> expectResponse = restWebClientTest.postMethodWithAuthAcceptance
                (FAVORITE_BASE_URL.getUrl(), FAVORITE_INPUT_JSON, Favorite.class, getJwt());
